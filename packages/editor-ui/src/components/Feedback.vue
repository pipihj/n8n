...
<template>
	<div class="feedback">
		<N8nText v-if="modelValue" :color="modelValue === 'positive' ? 'success' : 'danger'">
			<FontAwesomeIcon
		...
		<N8nTooltip v-if="!modelValue" :content="i18n.baseText('feedback.positive')">
			<span class="feedback-button" @click="onFeedback('positive')">
				<FontAwesomeIcon icon="thumbs-up" />
			</span>
		</N8nTooltip>
		<N8nTooltip v-if="!modelValue" :content="i18n.baseText('feedback.negative')">
			<span class="feedback-button" @click="onFeedback('negative')">
